...
The first step would be to clone the repo onto the VM. We need it to run the install script.

Follow the instruction in the [github page](git-github.qmd#git-and-github) to clone the repository and create tehe permissions to run the app on the VM.
...
When I get it look here for further instructions - file:///Users/yeroslaviz/Documents/Github/BCFNGS-project-management/_site/chapters/setup-infrastructure.html#ssl-certificate-for-https
