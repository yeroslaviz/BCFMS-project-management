...
ms_seed_defaults <- function(con) {
  ...
  project_creation_body <- paste(
    "Dear {budget_holder},",
    "",
    "A new Mass Spectrometry Core Facility project has been submitted under cost center {cost_center}.",
    "",
    "{warning}",
    "",
    "Project summary:",
  ...
  data_release_body <- paste(
    ...
    "{warning}",
    "",
    "Please contact the facility if you have questions about the released files or report.",
    "",
    "Best regards,",
    "Mass Spectrometry Core Facility",
    sep = "\n"
  ...
  cost_body <- paste(
    ...
    "",
    "This text is a placeholder and can be adjusted once the final wording is available.",
    "",
    "Best regards,",
    "Mass Spectrometry Core Facility",
    sep = "\n"
